      ...
      <div className="option-columns">
        ...
        <div className="option-column">
          <input
            ...
            value={player1.name}
            id="player-1-name"
            onChange={e => setPlayerName(player1.id, e.target.value)}
          />
          <input
            type="checkbox"
            id="player-1-ai"
            checked={player1.isAI}
            onChange={e => setPlayerAI(player1.id, e.target.checked)}
          />
          ...
          <input
            ...
            value={player2.name}
            id="player-2-name"
            onChange={e => setPlayerName(player2.id, e.target.value)}
          />
          <input
            type="checkbox"
            id="player-2-ai"
            checked={player2.isAI}
            onChange={e => setPlayerAI(player2.id, e.target.checked)}
          />
          ...
          <input
            ...
            onBlur={e => setAIMoveDelay(parseInt(e.target.value, 10))}
          />
          ...
          <input
            ...
            onBlur={e => setAnimationDuration(parseInt(e.target.value, 10))}
          />
